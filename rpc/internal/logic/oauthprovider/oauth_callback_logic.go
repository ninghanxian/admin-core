...
import (
	...
	"github.com/qmcloud/admin-common/msg/logmsg"
	...
	"github.com/qmcloud/admin-core/rpc/ent/oauthprovider"
	"github.com/qmcloud/admin-core/rpc/ent/user"

	user2 "github.com/qmcloud/admin-core/rpc/internal/logic/user"
