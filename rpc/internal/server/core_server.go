...
import (
	...
	"github.com/qmcloud/admin-core/rpc/internal/logic/api"
	"github.com/qmcloud/admin-core/rpc/internal/logic/authority"
	"github.com/qmcloud/admin-core/rpc/internal/logic/base"
	"github.com/qmcloud/admin-core/rpc/internal/logic/department"
	"github.com/qmcloud/admin-core/rpc/internal/logic/dictionary"
	"github.com/qmcloud/admin-core/rpc/internal/logic/dictionarydetail"
	"github.com/qmcloud/admin-core/rpc/internal/logic/menu"
	"github.com/qmcloud/admin-core/rpc/internal/logic/oauthprovider"
	"github.com/qmcloud/admin-core/rpc/internal/logic/position"
	"github.com/qmcloud/admin-core/rpc/internal/logic/role"
	"github.com/qmcloud/admin-core/rpc/internal/logic/token"
	"github.com/qmcloud/admin-core/rpc/internal/logic/user"
