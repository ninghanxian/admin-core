...
kubectl patch configmap tcp-services -n ingress-nginx --patch '{"data":{"9100":"admin/core-api-svc:9100"}}'

# register backend-ui, port 8080 is mapped to port 80 of backend-ui
kubectl patch configmap tcp-services -n ingress-nginx --patch '{"data":{"8080":"admin/backend-ui-svc:80"}}'
